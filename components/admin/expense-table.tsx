...
import { CalendarRange, Landmark, SlidersHorizontal } from "lucide-react";
import {
  createExpense,
  deleteExpense,
  updateExpense,
        ...
        <CardContent className="space-y-5 pb-6 pt-5">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className="metric-tile rounded-[22px] p-4">
              ...
              <div className="mt-2 font-semibold">{rangeLabel}</div>
            </div>
            <div className="metric-tile rounded-[22px] p-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <div className="mt-2 font-semibold">
                {categoryFilter === "all"
                  ? "Бүх ангилал"
                  : getExpenseCategoryLabel(categoryFilter as ExpenseCategory)}
              </div>
            </div>
            <div className="metric-tile rounded-[22px] p-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <TableBody>
                {filtered.length === 0 ? (
                  ...
                  filtered.map((expense) => (
                    <TableRow
                      key={expense.id}
                      className="glass-row border-white/20">
                ...
                <TableRow className="border-t border-white/20 bg-primary/5 font-semibold">
      ...
      <Dialog
        ...
        <DialogContent className="glass-dialog rounded-[30px] border-white/60">
          ...
          <p className="text-sm text-muted-foreground">
            Энэ зардлын мөрийг устгахдаа итгэлтэй байна уу?
          </p>
