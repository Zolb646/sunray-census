...
export function InventoryTable({ initialItems }: InventoryTableProps) {
  ...
  async function handleImageUpload(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      if (!response.ok || !result.url) {
        throw new Error(result.error ?? "Зураг байршуулж чадсангүй.");
      }
      ...
      setUploadError(
        error instanceof Error ? error.message : "Зураг байршуулж чадсангүй.",
      );
    } finally {
      setUploadingImage(false);
      event.target.value = "";
  ...
  return (
    <div className="space-y-6">
      <section className="toolbar-surface flex flex-wrap items-center justify-between gap-4 rounded-[28px]">
        <div className="flex flex-1 flex-wrap items-center gap-3">
          <div className="relative min-w-60 flex-1 max-w-sm">
            ...
            <Input
              ...
              className="border-white/40 bg-white/60 pl-9 focus-visible:ring-primary/40"
            />
          </div>
          <Select value={categoryFilter} onValueChange={setCategoryFilter}>
            <SelectTrigger className="w-44 border-white/40 bg-white/60 focus:ring-primary/40">
      ...
      <section className="table-surface rounded-[30px]">
        <div className="flex items-center justify-between gap-4 border-b soft-divider px-5 py-4">
          <div>
            <div className="section-kicker">Каталогийн хүснэгт</div>
          ...
          <div className="hidden items-center gap-2 text-xs text-muted-foreground sm:flex">
            ...
            Каталогт нийт {initialItems.length} бараа байна
          </div>
        </div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="glass-dialog max-w-lg rounded-[32px] border-white/60">
          <DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  value={form.stockQty}
                  onChange={(event) =>
                    setForm({ ...form, stockQty: event.target.value })
                  }
                />
              </div>
              <div className="space-y-1">
              ...
              <div className="col-span-2 space-y-2">
                ...
                <div className="rounded-[24px] border border-dashed p-3">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
                    <label className="inline-flex cursor-pointer items-center gap-2 rounded-full border px-3 py-2 text-sm font-medium hover:bg-accent">
                      <span>
                        {uploadingImage
      ...
      <Dialog
        ...
        <DialogContent className="glass-dialog rounded-[30px] border-white/60">
          ...
          <p className="text-sm text-muted-foreground">
            Энэ үйлдэл нь бараа болон түүнтэй холбоотой нөөцийн хөдөлгөөнийг бүр
            мөсөн устгана. Буцаах боломжгүй.
          </p>
